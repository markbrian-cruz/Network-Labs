...
CustomerA1
```
$ snmpwalk -v2c -c CustomerA_ReadOnly 192.168.1.2 SNMPv2-MIB::sysName
...
CustomerA3
```
$ snmpwalk -v2c -c CustomerA_ReadOnly 192.168.1.3 SNMPv2-MIB::sysName
...
CustomerA2
```
$ snmpwalk -v2c -c CustomerA_ReadOnly 192.168.2.2 SNMPv2-MIB::sysName
...
CustomerA4
```
$ snmpwalk -v2c -c CustomerA_ReadOnly 192.168.2.3 SNMPv2-MIB::sysName
